"""
Reply distribution per user.

Computes is_self_reply from thread structure, then reports how many replies
each user contributed and what share would be affected by a per-user cap.

Run from project root:
    python scripts/reply_distribution.py
    python scripts/reply_distribution.py --input output/messages_structured_old.csv
"""
...
def main():
    parser = argparse.ArgumentParser(description="Reply distribution per user.")
    parser.add_argument(
        "--input",
