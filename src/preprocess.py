...
#   4. remove_intro_groups()   – drop welcome / intro threads
#   5. clean_dataframe()       – strip HTML, convert dates
#   6. filter_text_quality()   – min length, language
#   7. anonymize_ids()         – replace PosterID with user_N
#   8. anonymize_text_columns()– NER-based text anonymization
#   9. save_outputs()          – write per-account CSVs + review files
# =============================================================================
...
if ANONYMIZE_TEXT:
    try:
        ...
        print("WARNING: custom_text_anonymizer not installed – text anonymization skipped.")
